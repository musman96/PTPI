...
namespace PTPI.Data.Migrations
{
    ...
    [Migration("20260504111654_AddAdditionalColumnData")]
    partial class AddAdditionalColumnData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTPI.Models.Account", b =>
                {
                    b.Property<int>("Code")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PTPI.Models.Person", b =>
                {
                    b.Property<int>("Code")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PTPI.Models.Transaction", b =>
                {
                    b.Property<int>("Code")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PTPI.Models.Account", b =>
                {
                    b.HasOne("PTPI.Models.Person", "Person")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("PTPI.Models.Transaction", b =>
                {
                    b.HasOne("PTPI.Models.Account", "Account")
